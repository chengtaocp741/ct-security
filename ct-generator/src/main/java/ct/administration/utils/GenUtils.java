...
package ct.administration.utils;

import ct.administration.entity.ColumnEntity;
import ct.administration.entity.TableEntity;
...
public class GenUtils {
	...
	public static void generatorCode(Map<String, String> table,
		...
		mainPath = StringUtils.isBlank(mainPath) ? "ct.administration" : mainPath;
